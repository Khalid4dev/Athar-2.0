...
import { faMapMarkerAlt, faPhone, faFax, faEnvelope, faUser, faBuilding } from '@fortawesome/free-solid-svg-icons';
import {
    faFacebook,
    faInstagram,
    faTwitter,
    ...
    return (
        <>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-20 mx-auto max-w-screen-xl px-4">
                <div className="relative rounded-lg overflow-hidden shadow-md">
                    <div className="relative">
                        <Image src={helpImage} alt="Devenir Bénévole" className="object-cover w-full h-full rounded-lg" />
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6 mx-auto max-w-screen-xl">
                <div className="text-black p-8">
                    <div>
                        <div className="text-center pb-8">
                            <h1 className="text-4xl font-bold mb-4 border-b border-gray-300 p-4">Notre Coordonnées</h1>
                        ...
                        <div className="text-center pb-8">
                            <h1 className="text-4xl font-bold mb-4 border-b border-gray-300 p-4">RIB Compte bancaire</h1>
                            <div className="flex flex-col text-lg text-justify">
                                <div className="flex items-center mb-2">
                                    <FontAwesomeIcon icon={faUser} className="mr-2" />
                                    <p>Vous êtes un particulier ? RIB: 022 780 0001 320027394286 74 </p>
                                </div>
                                <div className="flex items-center mb-2">
                                    <FontAwesomeIcon icon={faBuilding} className="mr-2" />
                                    <p>Vous êtes une entreprise ? RIB: 022 780 0001 320005032973 74</p>
                                </div>
                            </div>
                        </div>
                        <div className="text-center mb-8">
                            <h1 className="text-4xl font-bold mb-4 border-b border-gray-300 p-4">Get in Touch With Us</h1>
                            <div className="flex justify-center items-center space-x-4 p-4">
                                <a href="#facebook" className="border border-blue-600 p-2 rounded-xl hover:bg-blue-600 hover:text-white">
                                    <FontAwesomeIcon icon={faFacebook} className="text-blue-600 text-lg" />
                                </a>
                                <a href="#instagram" className="border border-pink-600 p-2 rounded-xl hover:bg-pink-600 hover:text-white">
                                    <FontAwesomeIcon icon={faInstagram} className="text-pink-600 text-lg" />
                                </a>
                                <a href="#twitter" className="border border-blue-400 p-2 rounded-xl hover:bg-blue-400 hover:text-white">
                                    <FontAwesomeIcon icon={faTwitter} className="text-blue-400 text-lg" />
                                </a>
                                <a href="#linkedin" className="border border-blue-500 p-2 rounded-xl hover:bg-blue-500 hover:text-white">
                ...
                <div className="text-black p-8">
                    <h1 className="text-4xl text-center font-bold mb-4 border-b border-gray-300 p-4">Rejoignez-Nous</h1>
                    <p className="pb-2">Veuillez remplir le formulaire ci-dessous afin que nous puissions vous contacter rapidement pour soumettre votre demande</p>
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className="mb-4">
                            <label htmlFor="requestType" className="block text-lg font-semibold mb-2">
                                Type de Demande
                            </label>
                            <select
                                id="requestType"
