          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 max-w-screen-xl">
            <div className="p-5  order-1 sm:order-1 flex flex-col justify-center items-center">
              ...
              <div className="text-justify">
                <p>
                  Athar Alkhair, une association marocaine enracinée dans la
                  région de Rabat-Salé-Temara, se consacre à la promotion d'un
                  impact humanitaire positif et durable au sein de la société. À
                  travers ses missions, elle s'engage à mettre en œuvre des
                  actions caritatives destinées à apporter un soutien essentiel
                  aux habitants en difficulté évoluant dans des milieux ruraux.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-end order-2 sm:order-2">
              <Image
                className="sm:rounded-r-full rounded-none"
                src={aboutusimage}
                alt=""
              />
            </div>
            <div className="flex items-center justify-start order-4 sm:order-3">
              <Image
                className="sm:rounded-l-full rounded-none"
                src={aboutusimage}
                alt=""
              />
            </div>
            <div className="p-5 flex flex-col justify-center items-center order-3 sm:order-4">
              ...
              <div className="text-justify">
                <p>
                  Les missions d'Athar Alkhair s'articulent autour de la
                  création de programmes et d'initiatives visant à améliorer les
                  conditions de vie des populations vulnérables. Cela se
                  concrétise par la fourniture d'aide humanitaire, d'assistance
                  sociale, et le développement de projets ayant un impact
                  significatif sur le bien-être des bénéficiaires.
                </p>
              </div>
            </div>
            <div className="p-5 flex flex-col justify-center items-center order-5">
              <div className="mb-8 ">
                <div className="text-2xl font-bold sm:order-5">
                  Notre Vision
                </div>
              </div>
              ...
              <div className="text-justify">
                <p>
                  En regardant vers l'avenir, la vision d'Athar Alkhair se
                  dessine dans la création d'une société où chaque individu,
                  quel que soit son contexte, a accès à des opportunités
                  équitables, à une qualité de vie améliorée, et à un
                  environnement propice à son épanouissement. L'association
                  aspire à être un catalyseur de changement positif, laissant
                  ainsi un héritage durable et transformateur dans les
                  communautés qu'elle touche.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 order-7 sm:order-8 flex flex-col justify-center items-center">
              ...
              <div className="text-justify">
                <p>
                  Les valeurs fondamentales de l'association reposent sur des
                  principes tels que la solidarité, l'équité, et le respect de
                  la dignité humaine. Athar Alkhair œuvre pour instaurer un
                  climat de bienveillance, de partage, et de justice sociale au
                  cœur de ses actions, reflétant ainsi son engagement envers des
      ...
      <section className="relative w-full h-96 text-center pt-10">
        ...
        <div className="absolute text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center pt-7">
          ...
          <p className="text-white mb-6">
            Chaque enfant a le droit de grandir au sein d’une famille qui lui
            apporte affection, respect et protection. Chez SOS Villages
            d’Enfants, nous donnons un cadre familial à des enfants qui n’en ont
            pas ou qui risquent de la perdre et nous les aidons à bâtir leur
            avenir.
          </p>
